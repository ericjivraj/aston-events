...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <section class="culture" align="center">
        <h1 class="col-xs-12">Culture Events</h1>
                <?php
	                      $query = mysqli_query($connect, "SELECT * FROM event WHERE category like 'Culture'") or die("Couldn't not find any events!");
