...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <section class="others" align="center">
        <h1 class="col-xs-12">Others Events</h1>
                <?php
	                      $query = mysqli_query($connect, "SELECT * FROM event WHERE category LIKE 'Others'"); // Alterar Campos
	                      $count = mysqli_num_rows($query) or die("Couldn't not find any events!");
		                    if($count == 0) {
