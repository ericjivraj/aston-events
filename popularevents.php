  ...
  <body>
    ...
    <main>
      ...
      <section class="others" align="center">
        <h1 class="col-xs-12">Popular Events</h1>
                <?php
	                      $query = mysqli_query($connect, "SELECT * FROM event ORDER BY like_count DESC") or die("Couldn't not find any events!"); // Alterar Campos
